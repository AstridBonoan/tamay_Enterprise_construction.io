...
function PhotoIcon() {
  return (
    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M4 5h3l2-2h6l2 2h3a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2zm8 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 2.2a2.8 2.8 0 1 1 0 5.6 2.8 2.8 0 0 1 0-5.6z" />
    </svg>
  );
}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <AccountHubCard
            href="/m/bookings"
            title="Bookings"
            description="View consultations, service appointments, and scheduled visits."
            icon={<CalendarIcon />}
          />
          {user.isStaff && (
            <>
              <AccountHubCard
                href="/m/staff/schedule"
                title="Manage schedule"
                description="Add or remove appointment times customers can book."
                icon={<CalendarIcon />}
              />
              <AccountHubCard
                href="/m/staff/reviews"
                title="Manage reviews"
                description="Approve or hide website reviews before they appear publicly."
                icon={<ShieldIcon />}
              />
              <AccountHubCard
                href="/m/staff/images"
