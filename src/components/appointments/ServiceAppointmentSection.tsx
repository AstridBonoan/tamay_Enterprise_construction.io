...
export function ServiceAppointmentSection({ serviceId }: ServiceAppointmentSectionProps) {
  ...
  return (
    <section className="py-14 md:py-16 px-4 bg-gray-50 border-t border-gray-100">
