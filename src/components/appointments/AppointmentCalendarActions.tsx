...
type AppointmentCalendarActionsProps = {
  event: CalendarEventInput;
  icsFilename: string;
  compact?: boolean;
};

export function AppointmentCalendarActions({
  event,
  icsFilename,
  compact = false,
}: AppointmentCalendarActionsProps) {
  ...
  return (
    <div className="rounded-sm border border-tamay-primary/20 bg-tamay-primary/5 px-5 py-5 text-left max-w-md mx-auto">
      <p className="font-heading text-base font-semibold text-tamay-primary">Add this appointment to your calendar</p>
