    ...
    <section id="location" className="w-full">
      <div className="relative w-full h-[380px] sm:h-[420px] md:h-[460px] bg-gray-200">
        ...
        <a
          ...
          className="absolute left-3 sm:left-4 top-[128px] sm:top-[132px] z-10 inline-flex items-center gap-2 rounded-full bg-tamay-primary hover:bg-tamay-primary-dark text-white text-xs sm:text-sm font-bold tracking-widest uppercase px-4 py-2.5 shadow-lg transition-colors"
        >
          <DirectionsIcon />
          Get Directions
        </a>
