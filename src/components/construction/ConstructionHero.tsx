...
export function ConstructionHero() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="relative flex flex-col md:aspect-[16/9] md:max-h-[580px] md:min-h-[460px]">
        ...
        <div className="relative w-full aspect-[16/9] max-h-[min(58vw,360px)] shrink-0 md:absolute md:inset-0 md:max-h-none md:aspect-auto">
          <SitePhoto
