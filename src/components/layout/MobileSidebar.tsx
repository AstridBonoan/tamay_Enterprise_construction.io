  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden={!open}
        onClick={onClose}
        className={`fixed inset-0 z-[60] bg-black/50 backdrop-blur-[2px] transition-opacity duration-300 ease-out lg:hidden ${
      ...
      <aside
        ...
        aria-hidden={!open}
        className={`fixed top-0 left-0 z-[70] h-full w-[min(88vw,320px)] bg-white shadow-2xl flex flex-col lg:hidden transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
          open ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="flex items-center justify-between border-b border-gray-100 px-4 py-4 bg-tamay-primary">
