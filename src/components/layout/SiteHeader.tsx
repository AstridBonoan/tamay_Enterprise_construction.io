  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-100">
        ...
        <div className="relative flex items-center justify-between gap-2 px-3 h-16 sm:px-4 lg:hidden">
          <button
            type="button"
            className="relative z-20 p-2 -ml-1 text-tamay-primary rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors touch-manipulation"
          ...
          <Link
            href="/"
            className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 pointer-events-auto"
          >
            <Image
              src={IMAGES.logo}
          ...
          <a
            href={SITE.phoneTel}
            className="relative z-20 p-2 text-tamay-primary rounded-lg hover:bg-gray-100 touch-manipulation"
